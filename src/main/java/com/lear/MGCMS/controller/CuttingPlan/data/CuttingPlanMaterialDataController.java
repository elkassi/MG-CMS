...
@RestController
@RequestMapping("/api/cuttingPlanMaterialData")
public class CuttingPlanMaterialDataController {
	@Autowired
	private CuttingPlanMaterialDataService service;
	
	@GetMapping("/all")
	public Page<CuttingPlanMaterialData> findAll(
